...
![Login](screenshots/oscn.jpg)

---

## 📸 Visual Showcase

Berikut adalah tampilan antarmuka OSCN Bridge 2.0:

| Dashboard Utama                         | Halaman Login                   |
| :-------------------------------------- | :------------------------------ |
| ![Dashboard](screenshots/dashboard.jpg) | ![Login](screenshots/login.jpg) |
...
Kami menyediakan **OSCN Bridge 2.0**, sebuah layer integrasi berbasis _Adapter Pattern_ yang mendukung sistem berikut secara _out-of-the-box_:
