# OSCN: Open Source Campus Network
## Impact-Driven & Compliance-First Ecosystem

**OSCN** adalah platform revolusioner yang menjembatani interaksi sosial civitas akademika dengan kebutuhan administratif kepatuhan kementerian (Kemendiktisaintek). Platform ini dibangun dengan filosofi **"Compliance-First"** melalui mekanisme **"Shadow Reporting"**, di mana data pelaporan dipanen secara otomatis dari aktivitas sosial yang natural.

---

### Status Perkembangan Terkini (Current Progress)

1.  **Compliance Core (BKD & MBKM)**:
...
### Roadmap Pengembangan (The Way Forward)

#### **Fase 1: Keunggulan Administrasi (COMPLETED)**
...
*   **Industry Portal**: Membuka akses terbatas bagi industri untuk melihat "Impact Portfolios" mahasiswa dan riset dosen.
*   **SDG Marketplace**: Menghubungkan tantangan di masyarakat dengan solusi riset/pengabdian dari kampus.
*   **Predictive IKU Analytics**: AI yang memprediksi capaian IKU di akhir tahun berdasarkan tren aktivitas sosial saat ini.

#### **Fase 4: Institusional Branding & AI-Agent (Q4 2026)**
*   Automated Institutional Report Generation (One-Click Report).
*   AI Compliance Agent: Chatbot yang membantu civitas melengkapi bukti (evidence) pelaporan.
*   OSCN Network Expansion: Integrasi antar kampus untuk kolaborasi riset lintas institusi.

---

**Visi Akhir**: Menjadikan OSCN sebagai sistem saraf pusat kampus yang secara otomatis membuktikan bahwa **Kampus Memberikan Dampak Nyata bagi Bangsa.**
